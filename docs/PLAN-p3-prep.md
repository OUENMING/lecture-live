...
> ⭐ **第二批的详细方案已经另起一份**：`docs/PLAN-entry-panel.md`（含三份 UX 调研、
> 作者拍板的 6 个决定、以及「美感与创新」的设计取向）。**本节只留最初的骨架**，
> 详细口径以那份为准。
>
> ⚠️ 有一处**已经变了**：作者 2026-09-26 把第二批从「一个准备窗口」升级成了
> **「课程卡片面板」**（双击 `.app` → 面板 → 点卡片开始上课）。见那份 §0 / §3.1。
